...
(function () {
  ...
  function MainController($scope, $http, $log, GraphHelper) {
    ...
    vm.getFolderItems = function(folderid){
      //Fetch items for the folder handler comes here
    }
    ...
    vm.getAllGroups = function(){
      //Groups handler comes here
    }

    vm.getUserGroups = function (usrid){
     //Fetch Groups for the user handler comes here
    }

    vm.getGroupUsers = function(grpid){
      //Get All Users based on group handler comes here
